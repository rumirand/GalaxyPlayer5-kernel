...
#define CONFIG_VENTURI_BOARD_REV	0x06
...
//TNP_AWB_GRID_MODULECOMP
  ...
  0x002A028A,
  0x0F120001,   //REG_TC_GP_bUse1FrameCaptureMode 0 Continuous mode 1 Single frame mode
...
static const u32 s5k4ecgx_WDR_on[] = { // CHECK_IT
};

static const u32 s5k4ecgx_WDR_off[] = { // CHECK_IT
};
...
static const u32 s5k4ecgx_Contrast_Minus_4[] = { // CHECK_IT
};
static const u32 s5k4ecgx_Contrast_Minus_3[] = { // CHECK_IT
};
...
static const u32 s5k4ecgx_Contrast_Plus_3[] = { // CHECK_IT
};

static const u32 s5k4ecgx_Contrast_Plus_4[] = { // CHECK_IT
};

                //Normal Config ADJUST Sharpness
static const u32 s5k4ecgx_Sharpness_Minus_3[] = { // CHECK_IT
};
...
static const u32 s5k4ecgx_Sharpness_Plus_3[] = { // CHECK_IT
};
...
static const u32 s5k4ecgx_Auto_Contrast_ON[] = { // CHECK_IT
  0xFCFCD000,                                          
  0x00287000,                                          
  0x002A098E, 
  0x0F12FFB0,
...
static const u32 s5k4ecgx_Auto_Contrast_OFF[] = { // CHECK_IT 
  0xFCFCD000,                                          
  0x00287000,                                          
  0x002A098E, 
  0x0F120000,
...
static const u32 s5k4ecgx_Night_Capture[] = { // CHECK_IT
};

static const u32 s5k4ecgx_Beach_Snow_Fire_Capture[] = { // CHECK_IT
};
...
static const u32 s5k4ecgx_AF_Normal_mode_4[] = { // CHECK_IT
  0x00287000,
  0x002A1648,
  0x0F129002,
};
...
static const u32 s5k4ecgx_AF_Low_Light_normal_mode_1[] = { // CHECK_IT
};
static const u32 s5k4ecgx_AF_Low_Light_normal_mode_2[] = { // CHECK_IT
};
static const u32 s5k4ecgx_AF_Low_Light_normal_mode_3[] = { // CHECK_IT
};
static const u32 s5k4ecgx_AF_Low_Light_Macro_mode_1[] = { // CHECK_IT
};
static const u32 s5k4ecgx_AF_Low_Light_Macro_mode_2[] = { // CHECK_IT
};
static const u32 s5k4ecgx_AF_Low_Light_Macro_mode_3[] = { // CHECK_IT
};
static const u32 s5k4ecgx_AF_Low_Light_Mode_On[] = { // CHECK_IT
};
static const u32 s5k4ecgx_AF_Low_Light_Mode_Off[] = { // CHECK_IT
};
...
static const u32 s5k4ecgx_Face_Detection_On[] = { // CHECK_IT
	0x00287000,
	0x002A0294,
	0x0F120100,
	0x0F1200E3,
...
static const u32 s5k4ecgx_Face_Detection_Off[] = { // // CHECK_IT
	0x00287000,
	0x002A0294,
	0x0F120100,
	0x0F1200E3,
...
static const u32 s5k4ecgx_Night_Mode_On[] = { // CHECK_IT

};

static const u32 s5k4ecgx_Night_Mode_Off[] = { // CHECK_IT

};


               // restores crop settings to full resolution
static const u32 s5k4ecgx_Reset_Crop[] = {  // CHECK_IT
	0x002A0250,
	0x0F120A00,
	0x0F120780,
	0x0F120010,
...
static const u32 s5k4ecgx_Capture_Config[] ={  // CHECK_IT
  0x00287000,
  0x002A0242,
  0x0F120001,
  0x002A024E,
...
static const u32 s5k4ecgx_Flash_End[] = {
  ...
  0x0F120000,	
                ...
                // Camera Config Capture Size Config // CHECK_IT
...
static const u32 s5k4ecgx_176_Preview[] = {
	...
	0x0F120001,	/* #REG_TC_GP_CapConfigChanged */
                ...
                // Camcorder Size Config // CHECK_IT
...
static const u32 s5k4ecgx_1280_Camcorder[] =
{
  ...
  0x0F1202D0,//	#REG_0TC_PCFG_usHeight//Vsize   : 480       //
              ...
              // FRAME RATE
  0x002A02C2,
  0x0F12014A, //REG_0TC_PCFG_usMaxFrTimeMsecMult10 30frame fix//		
  0x0F12014A, //REG_0TC_PCFG_usMinFrTimeMsecMult10 30frame fix//	
  ...
  0x002A13EC,   //Outdoor Grid Offset
  0x0F120000, 
  0x0F12FFD0, 
  0x0F12FFC0,  
  0x0F120000, 
...
static const u32 s5k4ecgx_592_Camcorder[] = {
	0x00287000,
	...
	0x002A0250,
	0x0F120940,	/* #REG_TC_GP_PrevReqInputWidth */
	0x0F120780,	/* #REG_TC_GP_PrevReqInputHeight */
	0x0F120070,	/* #REG_TC_GP_PrevInputWidthOfs	*/
	0x0F12000C,	/* #REG_TC_GP_PrevInputHeightOfs */
	0x002A0494,
	0x0F120940,	/* #REG_TC_PZOOM_PrevZoomReqInputWidth */
	0x0F120780,	/* #REG_TC_PZOOM_PrevZoomReqInputHeight	*/
	0x0F120000,	/* #REG_TC_PZOOM_PrevZoomReqInputWidthOfs	*/
	0x0F120000,	/* #REG_TC_PZOOM_PrevZoomReqInputHeightOfs */
	0x002A0262,
...
static const u32 s5k4ecgx_176_Camcorder[] = {
  ...
  0x0F120001,   //70000D18 AFITB_bnr_nClustLevel_C      [0]   bWideWide[1]  
	...
	0x0F120001,	/* #REG_TC_GP_CapConfigChanged */
                ...
                // AE Lock
static const u32 s5k4ecgx_ae_lock[] = { // CHECK_IT
  0x00287000,
  0x002A2C5E,
  0x0F120000,
};
                ...
                // AE unLock
static const u32 s5k4ecgx_ae_unlock[] = { // CHECK_IT
  0x00287000,
  0x002A2C5E,
  0x0F120001,
};
                ...
                // AWB Lock
static const u32 s5k4ecgx_awb_lock[] = { // CHECK_IT
  0x00287000,
  0x002A2C66,
  0x0F120000,
};
                ...
                // AWB unLock
static const u32 s5k4ecgx_awb_unlock[] = { // CHECK_IT
  0x00287000,
  0x002A2C66,
  0x0F120001,
};

static const u32 s5k4ecgx_Get_AE_Stable_Status[] = { // CHECK_IT
  0x002E2C74,
};

static const u32 s5k4ecgx_Get_Light_Level[] = {  // CHECK_IT
	0xFCFCD000,
	0x002C7000,
	0x002E2C18,
};

static const u32 s5k4ecgx_get_1st_af_search_status[] = {  // CHECK_IT
	0x002E2EEE,
};

static const u32 s5k4ecgx_get_2nd_af_search_status[] = {  // CHECK_IT
	0x002E2207,
};

static const u32 s5k4ecgx_get_capture_status[] = {  // CHECK_IT
	0x002E0530,
};

static const u32 s5k4ecgx_get_esd_status[] = {  // CHECK_IT
	0xFCFCD000,
	0x002CD000,
	0x002E0060,
};

static const u32 s5k4ecgx_get_iso_reg[] = {  // CHECK_IT
	0x002C7000,
	0x002E2BC4,
};

static const u32 s5k4ecgx_get_shutterspeed_reg[] = {  // CHECK_IT
	0x002C7000,
	0x002E2BC0,
};
...
static const u32 s5k4ecgx_return_night_preview[] = {  // CHECK_IT
};

static const u32 s5k4ecgx_return_beach_Fireworks_preview[] = {  // CHECK_IT
};
                // DIGITAL ZOOM
...
static const u32 s5k4ecgx_init_reg2_Qik[] = {
  ...
  0x0F120000,   //REG_TC_IPRM_NumberOfMipiLanes
  0x002A021A,
  0x0F121D4C,   //REG_TC_IPRM_OpClk4KHz_0 SCLK: 60Mhz
  0x0F123A98,   //REG_TC_IPRM_MinOutRate4KHz_0	PCLK Min : 81Mhz
  0x0F123A98,   //REG_TC_IPRM_MaxOutRate4KHz_0	PCLK Max : 81Mhz
  0x0F121D4C,   //REG_TC_IPRM_OpClk4KHz_1	SCLK 	 : 81Mhz
  0x0F123A98,   //REG_TC_IPRM_MinOutRate4KHz_1	PCLK Min : 81Mhz
  0x0F123A98,   //REG_TC_IPRM_MaxOutRate4KHz_1 PCLK Max : 81Mhz
  0x002A022C,
  0x0F120001,   //REG_TC_IPRM_InitParamsUpdated
  ...
  0x0F1201E0,   //REG_0TC_PCFG_usHeight
  0x0F120005,   //REG_0TC_PCFG_Format	5 YUV	7 Raw	9 JPG
  0x0F123A98,   //REG_0TC_PCFG_usMaxOut4KHzRate
  0x0F123A98,   //REG_0TC_PCFG_usMinOut4KHzRate
  0x0F120100,   //REG_0TC_PCFG_OutClkPerPix88
  0x0F120300,   //REG_0TC_PCFG_uBpp88
  0x0F120052,   //REG_0TC_PCFG_PVIMask
  0x0F120000,   //REG_0TC_PCFG_OIFMask
  ...
  0x0F123A98,   //REG_0TC_CCFG_usMaxOut4KHzRate
  0x0F123A98,   //REG_0TC_CCFG_usMinOut4KHzRate
  0x0F120100,   //REG_0TC_CCFG_OutClkPerPix88
  0x0F120300,   //REG_0TC_CCFG_uBpp88
  ...
  0x0F120000,   //REG_0TC_CCFG_usFrTimeType
  0x0F120001,   //REG_0TC_CCFG_FrRateQualityType
...
static const u32 s5k4ecgx_640_Preview_Qik[] = {
  ...
  0x002A059C,
  0x0F120470,   //lt_uMaxAnGain1
  0x0F121000,   //lt_uMaxAnGain2
  0x0F120100,   //lt_uMaxDigGain
  0x0F122000,   //lt_uMaxTotGain
               
  0x002A0608,                                                          
  0x0F120001,   //lt_ExpGain_uSubsamplingmode                          
  0x0F120001,   //lt_ExpGain_uNonSubsampling                           
  0x0F121000,	//1400   //lt_ExpGain_ExpCurveGainMaxStr                        
  0x0F120100,   //0100   //lt_ExpGain_ExpCurveGainMaxStr_0__uMaxDigGain
  ...
  0x002A0A1C,
  0x0F1200B0,
  0x0F121450,   //70000A1E AFIT8_ccm_oscar_iSaturation   [7:0] AFIT8_RGB2YUV_iYOffset                   	 
