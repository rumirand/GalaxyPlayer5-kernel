	...
	unsigned int ioctl_cmd,  unsigned long arg)
{
	...
	case Si4709_IOC_POWERDOWN:
		pr_debug("%s: IOC_POWERDOWN called\n", __func__);
	...
	{
		int band;
		pr_debug("%s: IOC_BAND_SET called\n", __func__);
	...
	{
		int ch_spacing;
		pr_debug("%s: IOC_CHAN_SPACING_SET called\n", __func__);
	...
	{
		u32 frequency;
		pr_debug("%s; IOC_CHAN_SELECT called\n", __func__);
	...
	{
		u32 frequency;
		pr_debug("%s: IOC_CHAN_GET called\n", __func__);
		ret = Si4709_dev_chan_get(&frequency);
		if (ret < 0)
			debug("%s: IOC_CHAN_GET failed\n", __func__);
	...
	{
		u32 frequency;
		pr_debug("%s: IOC_SEEK_DOWN called\n", __func__);
	...
	{
		u8 RSSI_seek_th;
		pr_debug("%s: IOC_RSSI_SEEK_TH_SET called\n", __func__);
	...
	{
		u8 seek_SNR_th;
		pr_debug("%s:_IOC_SEEK_SNR_SET called\n", __func__);
	...
	{
		u8 seek_FM_ID_th;
		pr_debug("%s: IOC_SEEK_CNT_SET called\n", __func__);
	...
	{
		rssi_snr_t  data;
		pr_debug("%s: IOC_CUR_RSSI_GET called\n", __func__);
	...
	case Si4709_IOC_VOLEXT_ENB:
		pr_debug("%s: IOC_VOLEXT_ENB called\n", __func__);
	...
	case Si4709_IOC_VOLEXT_DISB:
		pr_debug("%s: IOC_VOLEXT_DISB called\n", __func__);
	...
	{
		u8 volume;
		pr_debug("%s: IOC_VOLUME_SET called\n", __func__);
	...
	{
		u8 volume;
		pr_debug("%s: IOC_VOLUME_GET called\n", __func__);
	...
	case Si4709_IOC_DSMUTE_ON:
		pr_debug("%s: IOC_DSMUTE_ON called\n", __func__);
	...
	case Si4709_IOC_DSMUTE_OFF:
		pr_debug("%s: IOC_DSMUTE_OFF called\n", __func__);
	...
	case Si4709_IOC_MUTE_OFF:
		pr_debug("%s: IOC_MUTE_OFF called\n", __func__);
	...
	case Si4709_IOC_MONO_SET:
		pr_debug("%s: IOC_MONO_SET called\n", __func__);
	...
	case Si4709_IOC_STEREO_SET:
		pr_debug("%s: IOC_STEREO_SET called\n", __func__);
	...
	case Si4709_IOC_RSTATE_GET:
	{
		...
		pr_debug("%s: IOC_RSTATE_GET called\n", __func__);
	...
	{
		radio_data_t data;
		pr_debug("%s: IOC_RDS_DATA_GET called\n", __func__);
	...
	case Si4709_IOC_RDS_ENABLE:
		pr_debug("%s: IOC_RDS_ENABLE called\n", __func__);
	...
	case Si4709_IOC_RDS_DISABLE:
		pr_debug("%s: IOC_RDS_DISABLE called\n", __func__);
	...
	{
		u32  time_out;
		pr_debug("%s: IOC_RDS_TIMEOUT_SET called\n", __func__);
	...
	case Si4709_IOC_SEEK_CANCEL:
		pr_debug("%s: IOC_SEEK_CANCEL called\n", __func__);
	...
	{
		device_id dev_id;
		pr_debug("%s: IOC_DEVICE_ID called\n", __func__);
	...
	case Si4709_IOC_SYS_CONFIG2_GET:
	{
		...
		pr_debug("%s: IOC_SYS_CONFIG2 called\n", __func__);
	...
	case Si4709_IOC_SYS_CONFIG3_GET:
	{
		...
		pr_debug("%s: IOC_SYS_CONFIG3 called", __func__);
	...
	case Si4709_IOC_POWER_CONFIG_GET:
	{
		...
		pr_debug("%s: IOC_POWER_CONFIG called", __func__);
	...
	{
		u8 afc;
		pr_debug("%s: IOC_AFCRL_GET called\n", __func__);

		ret = Si4709_dev_AFCRL_get(&afc);
		if (ret < 0)
			debug("%s: IOC_AFCRL_GET failed\n", __func__);
	...
	{
		status_rssi status;
		pr_debug("%s: IOC_STATUS_RSSI_GET called\n", __func__);
	...
	case Si4709_IOC_SYS_CONFIG2_SET:
	{
		sys_config2 sys_conf2;
		unsigned long n;
		pr_debug("%s: IOC_SYS_CONFIG2_SET called\n", __func__);
	...
	case Si4709_IOC_SYS_CONFIG3_SET:
	{
		sys_config3 sys_conf3;
		unsigned long n;
		pr_debug("%s: IOC_SYS_CONFIG3_SET called", __func__);
	...
	case Si4709_IOC_RESET_RDS_DATA:
		pr_debug("%s: IOC_RESET_RDS_DATA called\n", __func__);
